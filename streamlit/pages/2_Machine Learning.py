...
model_paths = {
    "Régression Logistique": r"C:\Users\LENOVO\Downloads\projet theorie info\projet theorie info\streamlit\models\logistic_regression_model.pkl",
    "Random Forest": r"C:\Users\LENOVO\Downloads\projet theorie info\projet theorie info\streamlit\models\random_forest_model.pkl",
    "SVM": r"C:\Users\LENOVO\Downloads\projet theorie info\projet theorie info\streamlit\models\svm_model.pkl"
}
...
language_icons = {
    "French": "https://www.countryflags.com/wp-content/uploads/france-flag-png-xl.png",
    "English": "https://images.emojiterra.com/twitter/v13.1/512px/1f1ec-1f1e7.png",
    "Italian": "https://flagpedia.net/data/flags/w580/it.png",
    "Spanish": "https://cdn.countryflags.com/thumbs/spain/flag-400.png",
    "Inconnu": "❓"
}
...
if st.session_state.analysis_done:
    ...
    if predict_button:
        ...
        flag_url = language_icons.get(predicted_language, None)

        if flag_url:
            st.markdown(f"""
                <div style='background-color: #273346; padding: 20px; border-radius: 10px; text-align: center;'>
                    <img src='{flag_url}' width='100' style='margin-bottom: 10px; border-radius: 5px;'>
